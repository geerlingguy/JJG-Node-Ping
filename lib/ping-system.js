...
exports.ping = function ping(address, callback) {
    ...
    // Record the process's stdout to a buffer.
    var data_buffer;
    ...
    process.stdout.on('end', function () {
        ...
        // Sometimes there is no data if the domain is invalid.
        if (typeof data_buffer === 'undefined') {
            ...
            if (!array[time_param] || array.indexOf('Unreachable') > -1 || array.indexOf('exceeded') > -1 || array.indexOf('Unknown host') > -1 || array.indexOf('not known') > -1 || array.indexOf('Temporary failure') > -1) {
                status = false;
                latency = 0;
            }
